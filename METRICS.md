...
![Before - baseline explain() on 2 real logs](screenshots/travel-log-baseline-explain.png)
...
![Before - COLLSCAN with 8,000 seeded records](screenshots/travel-log-before-collscan.png)
...
![After - IXSCAN/FETCH via createdAt index](screenshots/travel-log-after-ixscan.png)
...
![Deployment - changes committed and pushed](screenshots/travel-log-git-push.png)
