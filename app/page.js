...
const page = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#f7f5f0]">
      ...
      {/* heading section */}
      <div className="relative min-h-screen flex flex-col overflow-hidden">
        <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1600&h=900&fit=crop&auto=format" alt="" className="absolute inset-0 w-full h-full object-cover object-center hero-kenburns"/>
